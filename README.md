...
## Live Tool Link Catalog

The template now includes a live SimpleKit tool URL catalog in:

- `assets/js/simplekit-tool-links.js`

Use that file as the source of truth for related-tool cards, inline cross-links, or recommended next-tool CTAs instead of inventing or typing URLs manually.

Current live URLs were matched to `https://simplekit.app/` on March 16, 2026.
